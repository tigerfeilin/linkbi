...
import com.linkbi.activiti.mapper.ActWorkflowFormDataMapper;
import com.linkbi.activiti.domain.ActWorkflowFormData;
import com.linkbi.activiti.service.IActWorkflowFormDataService;
...
public class ActWorkflowFormDataServiceImpl implements IActWorkflowFormDataService
{
    ...
    public int insertActWorkflowFormData(ActWorkflowFormData ActWorkflowFormData)
    {
        ...
        ActWorkflowFormData.setId(IdUtils.getId());
    ...
    public int insertActWorkflowFormDatas(List<ActWorkflowFormData> ActWorkflowFormDatas) {
        for (ActWorkflowFormData actWorkflowFormData:ActWorkflowFormDatas) {
            actWorkflowFormData.setId(IdUtils.getId());
        }
