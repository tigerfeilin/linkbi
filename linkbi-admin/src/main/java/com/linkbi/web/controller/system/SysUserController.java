...
import com.linkbi.common.utils.ServletUtils;
import com.linkbi.common.utils.StringUtils;
import com.linkbi.common.utils.poi.ExcelUtil;
import com.linkbi.framework.web.service.TokenService;
...
public class SysUserController extends BaseController
{
    ...
    public AjaxResult getInfo(@PathVariable(value = "userId", required = false) Long userId)
    {
        ...
        if (StringUtils.isNotNull(userId))
        {
            ...
            //ajax.put("postIds", postService.selectPostListByUserId(userId));//.stream().map(x -> x + "").collect(Collectors.toList()));
            //ajax.put("roleIds", roleService.selectRoleListByUserId(userId));//.stream().map(x -> x + "").collect(Collectors.toList()));
        }
        return ajax;
    }
