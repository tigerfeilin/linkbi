package com.linkbi.common.utils.file;
...
import com.linkbi.common.config.HuaWeiConfig;
import com.linkbi.common.config.NginxConfig;
import org.apache.commons.io.FilenameUtils;
import org.springframework.web.multipart.MultipartFile;
import com.linkbi.common.config.LinkBIConfig;
import com.linkbi.common.constant.Constants;
import com.linkbi.common.exception.file.FileNameLengthLimitExceededException;
import com.linkbi.common.exception.file.FileSizeLimitExceededException;
import com.linkbi.common.exception.file.InvalidExtensionException;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = LinkBIConfig.getProfile();
    ...
    private static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = LinkBIConfig.getProfile().length() + 1;
