...
import com.linkbi.datatx.core.util.ShardingUtil;
...
public class JobThread extends Thread {
    ...
    public void run() {
        ...
        while (!toStop) {
            ...
            try {
                ...
                if (tgParam != null) {
                    ...
                    // execute
                    JobLogger.log("<br>----------- datax-admin job execute start -----------<br>----------- Param:" + tgParam.getExecutorParams());
                    ...
                    if (tgParam.getExecutorTimeout() > 0) {
                        ...
                        try {
                            ...
                            JobLogger.log("<br>----------- datax-admin job execute timeout");
                            JobLogger.log(e);
                    ...
                    JobLogger.log("<br>----------- datax-admin job execute end(finish) -----------<br>----------- ReturnT:" + executeResult);
                ...
                JobLogger.log("<br>----------- JobThread Exception:" + errorMsg + "<br>----------- datax-admin job execute end(error) -----------");
            } finally {
                // 终止操作暂不监控状态
        ...
        logger.info(">>>>>>>>>>> datax-admin JobThread stoped, hashCode:{}", Thread.currentThread());
    }
}