...
public class TriggerCallbackThread {
    ...
    public static void pushCallBack(HandleCallbackParam callback) {
        ...
        logger.debug(">>>>>>>>>>> datax-admin, push callback request, logId:{}", callback.getLogId());
    }
    ...
    public void start() {
        ...
        triggerCallbackThread.setName("datax-admin, executor TriggerCallbackThread");
    ...
    private static String failCallbackFileName = failCallbackFilePath.concat("datax-admin-callback-{x}").concat(".log");
