package com.linkbi.datatx.core.executor;

import com.linkbi.datatx.core.biz.AdminBiz;
import com.linkbi.datatx.core.biz.ExecutorBiz;
import com.linkbi.datatx.core.biz.client.AdminBizClient;
import com.linkbi.datatx.core.biz.impl.ExecutorBizImpl;
import com.linkbi.datatx.core.handler.IJobHandler;
import com.linkbi.datatx.core.log.JobFileAppender;
import com.linkbi.datatx.core.thread.*;
import com.linkbi.datax.rpc.registry.ServiceRegistry;
import com.linkbi.datax.rpc.remoting.net.impl.netty_http.server.NettyHttpServer;
import com.linkbi.datax.rpc.remoting.provider.XxlRpcProviderFactory;
import com.linkbi.datax.rpc.serialize.Serializer;
import com.linkbi.datax.rpc.serialize.impl.HessianSerializer;
import com.linkbi.datax.rpc.util.IpUtil;
import com.linkbi.datax.rpc.util.NetUtil;
...
public class JobExecutor {
            ...
            for (Map.Entry<Long, JobThread> item : jobThreadRepository.entrySet()) {
                ...
                if (oldJobThread != null) {
                    try {
                        ...
                        logger.error(">>>>>>>>>>> datax-admin, JobThread destroy(join) error, jobId:{}", item.getKey(), e);
                    }
                }
            }
    ...
    public static IJobHandler registJobHandler(String name, IJobHandler jobHandler) {
        logger.info(">>>>>>>>>>> datax-admin register jobhandler success, name:{}, jobHandler:{}", name, jobHandler);
    ...
    public static JobThread registJobThread(long jobId, IJobHandler handler, String removeOldReason) {
        ...
        newJobThread.start();
        logger.info(">>>>>>>>>>> datax-admin regist JobThread success, jobId:{}, handler:{}", new Object[]{jobId, handler});
