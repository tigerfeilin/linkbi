...
import com.linkbi.datax.api.dto.*;
import com.linkbi.datax.api.domain.MetaDataSource;
import com.linkbi.datax.api.tool.datax.reader.*;
import com.linkbi.datax.api.tool.datax.writer.*;
...
import static com.linkbi.datax.db.util.JdbcConstants.*;

/**
 * 构建 com.linkbi.datax json的工具类
 *
 * @author
...
public class DataxJsonHelper implements DataxJsonInterface {
     ...
     * reader jdbc 数据源
     */
    private MetaDataSource readerDatasource;
    /**
     * writer jdbc 数据源
     */
    private MetaDataSource writerDatasource;
    /**
     * 写入的表
     */
    ...
    public void initReader(DataXJsonBuildDto dataxJsonDto, MetaDataSource readerDatasource) {
    ...
    public void initWriter(DataXJsonBuildDto dataxJsonDto, MetaDataSource readerDatasource) {
    ...
    public Map<String, Object> buildReader() {
        ...
        dataxPluginPojo.setMetaDatasource(readerDatasource);
