    ...
    public void start(){
        logrThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                while (!toStop) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < 3; i++) {
                            ...
                            xxlJobLogReport.setId(IdUtils.getId());
                        ...
                        if (!toStop) {
                            logger.error(">>>>>>>>>>> datax-admin, job log report thread error:{}", e);
                        }
                    }
                ...
                logger.info(">>>>>>>>>>> datax-admin, job log report thread stop");

            }
        });
        logrThread.setDaemon(true);
        logrThread.setName("datax-admin, admin JobLogReportHelper");
        logrThread.start();
    }
