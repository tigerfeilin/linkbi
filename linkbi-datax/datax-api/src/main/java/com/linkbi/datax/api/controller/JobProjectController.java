...
public class JobProjectController extends BaseController {
    ...
    @ApiOperation("新增数据")
    @PostMapping
    @Log(title = "DataX应用管理", businessType = BusinessType.INSERT)
    ...
    @PutMapping
    @ApiOperation("修改数据")
    @Log(title = "DataX应用管理", businessType = BusinessType.UPDATE)
    ...
    @DeleteMapping
    @ApiOperation("删除数据")
    @Log(title = "DataX应用管理", businessType = BusinessType.DELETE)
