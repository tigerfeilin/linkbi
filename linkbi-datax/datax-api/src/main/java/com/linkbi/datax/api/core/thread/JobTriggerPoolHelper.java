...
public class JobTriggerPoolHelper {
    ...
    public void start() {
        fastTriggerPool = new ThreadPoolExecutor(
                ...
                new ThreadFactory() {
                    ...
                    public Thread newThread(Runnable r) {
                        return new Thread(r, "datax-admin, admin JobTriggerPoolHelper-fastTriggerPool-" + r.hashCode());
                    }
                });
        ...
        slowTriggerPool = new ThreadPoolExecutor(
                ...
                new ThreadFactory() {
                    @Override
                    public Thread newThread(Runnable r) {
                        return new Thread(r, "datax-admin, admin JobTriggerPoolHelper-slowTriggerPool-" + r.hashCode());
                    }
                });
    }
    ...
    public void stop() {
        ...
        logger.info(">>>>>>>>> datax-admin trigger thread pool shutdown success.");
    }
