...
public class AdminBizTest {
    ...
    public void registry() throws Exception {
        ...
        RegistryParam registryParam = new RegistryParam(RegistryConfig.RegistType.EXECUTOR.name(), "datax-admin-executor-example", "127.0.0.1:9999");
