...
/**
 * 支持ClickHouse数据库的元数据操作
 * 
 * @author
 *
 */
public class DatabaseClickHouseImpl extends AbstractDatabase implements IDatabaseInterface {

	public DatabaseClickHouseImpl() {
		super(JdbcConstants.CLICKHOUSE_DRIVER);
	}
	private Table table;
