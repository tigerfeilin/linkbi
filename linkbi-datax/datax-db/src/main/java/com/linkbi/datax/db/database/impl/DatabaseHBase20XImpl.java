 ...
 *
 */
public class DatabaseHBase20XImpl extends AbstractDatabase implements IDatabaseInterface {

	public DatabaseHBase20XImpl() {
		super(JdbcConstants.HBASE20XSQL_DRIVER);
	}
	private Table table;
