...
export default {
  ...
  methods: {
    ...
    sendDBMsg(datasourceId,tableSchema,tableName)
    {
        this.$refs.rdbmswriter.readerDataSource.datasourceId = datasourceId;
        this.$refs.rdbmswriter.readerDataSource.schemaName = tableSchema;
        this.$refs.rdbmswriter.readerDataSource.tableName = tableName;
    },
  }
}
</script>
