...
export const dataType = [
  ...
  { name: 'bigserial', needQuotation: false, availableFunc: ['sum', 'avg', 'max', 'min', 'count', 'none'] },
  { name: 'int8', needQuotation: false, availableFunc: ['sum', 'avg', 'max', 'min', 'count', 'none'] },
  { name: 'int4', needQuotation: false, availableFunc: ['sum', 'avg', 'max', 'min', 'count', 'none'] },
  { name: 'int2', needQuotation: false, availableFunc: ['sum', 'avg', 'max', 'min', 'count', 'none'] },
  { name: 'blob', needQuotation: true, availableFunc: ['count', 'none'] },
  { name: 'varchar2', needQuotation: true, availableFunc: ['count', 'none'] },
  { name: 'nvarchar', needQuotation: true, availableFunc: ['count', 'none'] },
  { name: 'nvarchar2', needQuotation: true, availableFunc: ['count', 'none'] },
  { name: 'blob', needQuotation: true, availableFunc: ['count', 'none'] },
  { name: 'clob', needQuotation: true, availableFunc: ['count', 'none'] },
  { name: 'boolean', needQuotation: true, availableFunc: ['count', 'none'] },
]
